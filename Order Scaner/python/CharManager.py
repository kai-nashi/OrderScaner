...
class Window_CharManager(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        self.timer.timeout.connect(self._TimerAction)
        
        self.chars = []
                             
            # ELEMENT PROPERTIES
        self.BTN_Update.released.connect(self._CharUpdate)  
                
        self.BTN_MakeActive.released.connect(self._MakeActive)
        self.BTN_MakeNonActive.released.connect(self._MakeNonActive)
        
        self.BTN_Save.released.connect(self._SaveChars)
